export enum Ingredient {
  ...
  royalChampignons = 'royalChampignons',
...
export const UkToIngredient: Record<string, Ingredient> = {
  ...
  'соус помідорний': Ingredient.tomatoSauce,
  ...
  'теляча вирізка': Ingredient.vealTenderloin,
  ...
  'яйце куряче': Ingredient.eggs,
  'запечене яйце': Ingredient.bakedEggs,
  'яйця перепелині': Ingredient.quailEggs,
  ...
  'філе куряче': Ingredient.chickenFillet,
  ...
  'моцарела бебі': Ingredient.mozzarellaBaby,
  ...
  'кримська цибуля': Ingredient.crimeanOnion,
  ...
  'квашений огірок': Ingredient.picke,
  ...
  'чері': Ingredient.cherryTomatoes,
  ...
  'шампіньони': Ingredient.champignons,
  'шампіньйон королівський': Ingredient.royalChampignons,
