...
export const COMPANY_LIST: Company[] = [
  ...
  },
  {
    ...
    id: 563,
    categories: [
      { id: 7067, size: 50, slug: 'pizza', remove: [NUMBERS_WITH_CM] },
      { id: 7068, size: 30, slug: 'pizza30', remove: [NUMBERS_WITH_CM] },
    ],
  },
  {
    slug: 'picantico',
    id: 1103,
    categories: [
      { id: 13559, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
      { id: 13558, size: 35, slug: 'pizza35', remove: [NUMBERS_WITH_CM] },
    ],
  },
  {
    slug: 'thesad',
    ...
    categories: [
      ...
      { id: 32975, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
    ],
  },
  ...
  { slug: 'chicheri', id: 448, categories: [{ id: 35368, size: 30, slug: 'pizza30' }] },
  {
    ...
    id: 1338,
    categories: [
      { id: 16461, size: 30, slug: 'pizza30', remove: [NUMBERS_WITH_CM] },
      { id: 16704, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
    ],
  },
  { slug: 'bruno', id: 669, categories: [{ id: 8166, size: null, slug: 'pizza' }] },
  {
    ...
    id: 1026,
    categories: [
      { id: 13687, size: 30, slug: 'pizza30', remove: [NUMBERS_WITH_CM] },
      { id: 13686, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
    ],
  },
  { slug: 'riposo', id: 635, categories: [{ id: 7666, size: 30, slug: 'pizza' }] },
  {
    ...
    id: 2754,
    categories: [
      { id: 34248, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
      { id: 34245, size: 35, slug: 'pizza35', remove: [NUMBERS_WITH_CM] },
    ],
  },
  { slug: 'terassa', id: 1124, categories: [{ id: 42425, size: 30, slug: 'pizza30' }] },
  { slug: 'kucheri', id: 1111, categories: [{ id: 14047, size: 30, slug: 'pizza', remove: [NUMBERS_WITH_CM] }] },
  ...
  },
  {
    ...
    id: 3034,
    categories: [
      { id: 36919, size: 20, slug: 'pizza20', remove: [NUMBERS_WITH_CM] },
      { id: 36916, size: 30, slug: 'pizza30', remove: [NUMBERS_WITH_CM] },
      { id: 36913, size: 50, slug: 'pizza50', remove: [NUMBERS_WITH_CM] },
    ],
  },
  {
  ...
  { slug: 'aveceasare', id: 2633, categories: [{ id: 32894, size: 30, slug: 'pizza30', remove: [NUMBERS_WITH_CM] }] },
